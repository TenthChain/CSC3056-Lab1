...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
		...
		// Setup phase
		double initialAccountBalance = 15.00;
		double balanceToWithdraw = 12.35;		
		double balanceBefore = mainApp.getBalance("5495-1234");
		mainApp.addTransaction("5495-1234", initialAccountBalance);
		
		// Exercise phase
		mainApp.addTransaction("5495-1234", -balanceToWithdraw);
		double balanceAfter = mainApp.getBalance("5495-1234");
		assert balanceBefore - balanceToWithdraw == balanceAfter;
		System.out.println("testWithdrawals: TC1 passed.");
		
		// tear-down: put the system state back in where it was
		mainApp.addTransaction("5495-1234", -balanceAfter);
	}
